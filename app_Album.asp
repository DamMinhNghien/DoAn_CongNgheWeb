      ...
      <div class="App">
         ...
         <div class="App__nav-bar">
            ...
            <div class="App__playlists-nav">
               ...
               <div class="App__category-item"  id="DivTop"onclick="redirectFunction2('app_top.asp')">
                  <div class="icon">
               ...
               <div class="App__category-item" id="DivAlbum" onclick="redirectFunction2('app_Album.asp')">
               <div class="icon">
