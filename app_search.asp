...
%>
    ...
    <div class="App__nav-bar">
      ...
      <div class="App__categories-nav">
        <div class="App__category-item" data-target-page="app.asp" >
        ...
        <div id="DivSearch" class="App__category-item" data-target-page="app_search.asp">
        ...
        <div class="App__category-item">
          <div class="icon"><svg width="112" height="111" viewBox="0 0 112 111" fill="none"
              ...
              <rect width="7.96484" height="111.503" transform="matrix(0.869849 -0.493319 0.506711 0.862116 48 14.7345)"
                fill="#C4C4C4" />
            </svg>
          </div>
      ...
      <div class="App__playlists-nav">
        ...
        <div class="App__category-item">
          <div class="icon"><svg role="img" width="12" height="12" viewBox="0 0 527 483" fill="none"
              xmlns="http://www.w3.org/2000/svg">
