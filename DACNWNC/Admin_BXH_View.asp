        ...
        Case "add_new"
            ...
            Else 
                If adTenChuDe <> "" And adBiDanh = "" And adQuocGia = "" Then
                    sql = "INSERT INTO TopBXH(TenTop, AnhTOP, MotaTop, Loai, TopCategories) VALUES ('" & adTenTop & "', '" & adAnhTOP & "', '" & adMotaTop & "','Chủ đề','" & adTenChuDe & "')"
                    conn.execute sql 
                ...
                ElseIf adTenChuDe = "" And adBiDanh <> "" And adQuocGia = "" Then
                    sql = "INSERT INTO TopBXH(TenTop, AnhTOP, MotaTop, Loai, TopCategories) VALUES ('" & adTenTop & "', '" & adAnhTOP & "', '" & adMotaTop & "','Ca Sĩ','" & adBiDanh & "')"
                    conn.execute sql 
                    Session("product_error") = "Thêm mới thành công"
                    Response.Redirect("Admin_BXH_Search.asp")
                ElseIf adTenChuDe = "" And adBiDanh = "" And adQuocGia <> "" Then
                    sql = "INSERT INTO TopBXH(TenTop, AnhTOP, MotaTop, Loai, TopCategories) VALUES ('" & adTenTop & "', '" & adAnhTOP & "', '" & adMotaTop & "','Quốc Gia','" & adQuocGia & "')"
                    conn.execute sql 
                    Session("product_error") = "Thêm mới thành công"
                    Response.Redirect("Admin_BXH_Search.asp")
                Else
