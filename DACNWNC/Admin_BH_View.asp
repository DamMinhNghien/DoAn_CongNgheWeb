	...
	<%
		...
		case "add_new"
			...
			if (not rs.eof) then
				...
				sql = "insert into BaiHat(TenBaiHat,TacGia,MoTa,NgayPhatHanh,AnhBH,IDChuDe,QuocGia,DuongDan,BiDanh)values ('" & adTenBaiHat & "','" & adTacGia & "','" & adMoTa & "','" & adNgayPhatHanh& "','" & adAnhBH & "'," & adIDChuDe& ",'" & adQuocGia & "','" & adDuongDan & "','" & adBiDanh & "')"
		...
		case "save_edit"
			...
			rs.open sql, conn 
				...
				sql = "update BaiHat set TenBaiHat='" & adTenBaiHat & "',TacGia='" & adTacGia& "',MoTa = '" & adMoTa & "',NgayPhatHanh = '" & adNgayPhatHanh & "',AnhBH = '" & adAnhBH & "',IDChuDe = " & adIDChuDe & ",QuocGia = '" & adQuocGia & "',DuongDan = '" & adDuongDan & "',BiDanh = '" & adBiDanh & "' where IDBaiHat = " & adIDBaiHat
							'Response.write(sql)
				conn.execute sql 
