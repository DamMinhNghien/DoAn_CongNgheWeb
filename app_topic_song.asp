   ...
   <body>
      ...
      <div class="App">
         ...
         <div class="App__main-view">
            ...
            timage=request.querystring("TImage")
            Set rs1 = Server.CreateObject("ADODB.Recordset")
            sql1="select IDBaiHat,TenBaiHat,NgayPhatHanh,QuocGia,TenCaSi,AnhBH from BaiHat join CaSi on BaiHat.BiDanh=Casi.BiDanh Where IDChuDe like '"& tid &"'"
                rs1.open sql1, conn
            %>
            <h1 style="color: white;text-align: center;">SpotiFake topic playlist</h1>
            <div class="playlist-content">
               <div class="playlist-cover">
                  <img src="images\<%=timage%>" alt="">
               </div>
               <div class="playlist-info">
                  <div class="playlist-public"> Topic</div>
                  <div class="playlist-title"><%=tname%></div>
            ...
            <div class="playlist-songs-container">
               ...
               <div class="playlist-songs" >
                  <table>
                     ...
                     <tr class="songdetail"data-target-page="app_song.asp" >
                        <td><%=rs1("IDBaiHat")%></td>
                        <td class="song-title">
